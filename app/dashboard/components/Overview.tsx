...
function Overview({userSettings}: {userSettings: UserSettings}) {
  ...
  return (
    <>
      <div className='w-[95vw] flex flex-wrap items-center justify-between gap-2 py-6 px-4'>
        <h2 className='text-3xl font-bold text-muted-foreground'>Overview</h2>
      ...
      <div className='w-[92vw] flex gap-2 flex-col pl-[5vw]'> 
