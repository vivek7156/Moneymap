...
function History({userSettings}: {userSettings: UserSettings}) {
  ...
  return (
    <div className='container px-4'>
      <h2 className='mt-12 text-3xl font-bold px-4'>History</h2>
            ...
            <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                {
                    ...
                    <ResponsiveContainer width={"100%"} height={300}>
                        <BarChart height={300} data={historyDataQuery.data} barCategoryGap={5}>
                            ...
                            <XAxis stroke='#8888' fontSize={12} tickLine={false} axisLine={false} padding={{left: 5, right: 5}} dataKey={(data) => {
...
function CustomTooltip({active, payload, formatter}: any){
    ...
    return (
        <div className='min-w-[300px] rounded border bg-background p-4'>
            ...
            <TooltipRow formatter={formatter} label="Income" value={income} bgColor="bg-emerald-500" textColor="text-enerald-500" />
